    ...
    var db = {
        ...
        loadData: function(filter) {
            return $.grep(this.clients, function(client) {
                //return (!filter.Name2 || client.Name2.indexOf(filter.Name2) > -1)
                //    && (filter.Age2 === undefined || client.Age2 === filter.Age2)
                //    && (!filter.Address2 || client.Address2.indexOf(filter.Address2) > -1)
                //    && (!filter.Country2 || client.Country2 === filter.Country2)
                //    && (filter.Married2 === undefined || client.Married2 === filter.Married2);
    ...
    db.clients = [
        {
            ...
            "Age2": 61,
            "Country2": 6,
            "Address2": "Ap #897-1459 Quam Avenue",
            "Married2": false
        },
        {
            "Name2": "Connor Johnston",
            "Age2": 73,
            "Country2": 7,
            "Address2": "Ap #370-4647 Dis Av.",
            "Married2": false
        },
        {
            "Name2": "Lacey Hess",
            "Age2": 29,
            "Country2": 7,
            "Address2": "Ap #365-8835 Integer St.",
            "Married2": false
        },
        {
            "Name2": "Timothy Henson",
            "Age2": 78,
            "Country2": 1,
            "Address2": "911-5143 Luctus Ave",
            "Married2": false
        },
